                            ...
                            <div class="navbar-header">
                                <div class="body-menu-1">
                                    ...
                                    <a class="navbar-brand" href="/#">
                                        <figure>
                                            <img class="site_logo hidden-xs" src="assets/img/test001.png" alt="Site Logo">
                                            <img class="site_logo hidden-md hidden-lg hidden-sm" src="assets/img/test001.png" alt="Site Logo">
                                        </figure>
                                    </a>
                                </div>
                            </div>
